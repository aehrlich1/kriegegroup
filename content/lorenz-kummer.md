...
[+43-1-4277-79542](tel:+43-1-4277-79542)\
...
#### [Weisfeiler and Leman Go Gambling: Why Expressive Lottery Tickets Win](https://icml.cc/virtual/2025/poster/46332)

Lorenz Kummer, Samir Moustafa, Anatol Ehrlich, Franka Bause, Nikolaus Suess, Wilfried Gansterer, Nils Kriege

Proceedings of The 42th International Conference on Machine Learning

#### [On the Relationship Between Robustness and Expressivity of Graph Neural Networks](https://proceedings.mlr.press/v258/kummer25a.html)
...
#### [Crossfire: An Elastic Defense Framework for Graph Neural Networks Under Bit Flip Attacks](https://ojs.aaai.org/index.php/AAAI/article/view/33979)
...
#### [Attacking Graph Neural Networks with Bit Flips: Weisfeiler and Leman Go Indifferent](https://dl.acm.org/doi/10.1145/3637528.3671890)
...
#### [Adaptive Precision Training (AdaPT): A dynamic quantized training approach for DNNs](https://epubs.siam.org/doi/abs/10.1137/1.9781611977653.ch63)
